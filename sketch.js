...
function draw() {
  ...
  if(keyDown("up_arrow")){
	  Matter.Body. applyForce(bob1.body,bob1.body.position, {x:-46, y:-41})
	  Matter.Body. applyForce(bob5.body,bob5.body.position, {x:46, y:-41})
	  Matter.Body. applyForce(bob4.body,bob4.body.position, {x:46, y:-41})
  }
